    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.hero}>
          <img
            src="https://picsum.photos/seed/cream-pasta/1400/600"
            alt="매콤 크림 닭갈비 파스타"
          />
        </section>
        ...
        <section className={styles.intro}>
          <p className={styles.category}>양식</p>

          <h1 className={`font-display ${styles.title}`}>매콤 크림 닭갈비 파스타</h1>
          ...
          <div className={styles.authorRow}>
            <div className={styles.author}>
              ...
              <div>
                <p className={styles.authorName}>요리하는정원</p>
                <p className={styles.date}>2026.07.20</p>
              </div>
            </div>
        ...
        <section className={styles.processSection}>
          <h2 className={styles.sectionTitle}>조리 과정</h2>
        ...
        <section className={styles.reviewSection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>완성 후기</h2>
          ...
          <div className={styles.reviewList}>
            <article className={styles.review}>
              <div className={styles.reviewHeader}>
                <div>
                  <p className={styles.reviewName}>집밥러버</p>
            ...
            <article className={styles.review}>
              <div className={styles.reviewHeader}>
                <div>
                  <p className={styles.reviewName}>요리초보탈출</p>
        ...
        <section className={styles.relatedSection}>
          <h2 className={styles.relatedTitle}>이 레시피와 함께 보면 좋아요</h2>
            ...
            {relatedRecipes.map(recipe => (
              <article key={recipe.id} className={styles.relatedCard}>
                <div className={styles.relatedImageArea}>
                  ...
                  <span className={styles.relatedTag}>{recipe.tag}</span>
