  ...
  const recipes = [
    {
      ...
      comments: "341",
      image:
        "https://images.unsplash.com/photo-1645696301019-35adcb18cb4d?auto=format&fit=crop&w=400&q=80",
      avatar:
    ...
    },
    {
      ...
      comments: "112",
      image:
        "https://images.unsplash.com/photo-1599321955726-e04842669811?auto=format&fit=crop&w=400&q=80",
      avatar:
    ...
    },
    {
      ...
      comments: "412",
      image:
        "https://images.unsplash.com/photo-1520209268518-aec60b8bb5ca?auto=format&fit=crop&w=400&q=80",
      avatar:
          ...
          <div className={styles["active-filters"]}>
            {activeFilters.map(filter => (
              <span key={filter} className={`${styles["filter-chip"]} text-button`}>
                {filter}{" "}
                <button className={styles["remove-filter"]}>
                  <X size={14} />
                </button>
              </span>
            ))}
            <button
              className={`${styles["clear-filters"]} text-button`}
          ...
          <aside className={styles["sidebar"]}>
            <div className={styles["filter-group"]}>
              ...
              <div className={styles["filter-category"]}>
                <div className={`${styles["filter-title"]} text-button`}>
                  음식 종류 <ChevronDown size={16} />
                </div>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 에피타이저
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 메인 요리
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 샐러드
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 수프
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
              ...
              <div className={`${styles["filter-category"]} ${styles["border-top"]}`}>
                <div className={`${styles["filter-title"]} text-button`}>
                  식단 <ChevronDown size={16} />
                </div>
              </div>

              <div className={`${styles["filter-category"]} ${styles["border-top"]}`}>
                <div className={`${styles["filter-title"]} text-button`}>
                  난이도 <ChevronDown size={16} />
                </div>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 쉬움
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 보통
                </label>
                <label className={`${styles["checkbox-label"]} text-sm`}>
                  <input type="checkbox" /> 어려움
                </label>
              </div>

              <div className={`${styles["filter-category"]} ${styles["border-top"]}`}>
                <div className={`${styles["filter-title"]} text-button`}>
                  정렬 <ChevronDown size={16} />
                </div>
                <label className={`${styles["radio-label"]} text-sm`}>
                  <input type="radio" name="sort" /> 최신순
                </label>
                <label className={`${styles["radio-label"]} text-sm`}>
                  <input type="radio" name="sort" defaultChecked /> 인기순
                </label>
                <label className={`${styles["radio-label"]} text-sm`}>
          ...
          <main className={styles["recipe-main"]}>
            <div className={styles["results-header"]}>
              ...
              <div className={styles["view-toggles"]}>
                ...
                <button className={`${styles["view-btn"]} ${styles["active"]}`}>
                  <Grid size={18} />
                </button>
              </div>
            </div>
              ...
              {recipes.map(recipe => (
                <div key={recipe.id} className={styles["recipe-card"]}>
                  <div
                    ...
                    style={{ backgroundColor: "var(--brand-light-gray)" }}
                  >
                  ...
                  <div className={styles["recipe-content"]}>
                    ...
                    <div className={`${styles["recipe-stats"]} text-s`}>
                      ...
                      <span className={styles["views"]}>
                        <Heart size={14} /> {recipe.views}
                      </span>
                      <span className={styles["comments"]}>
                        <MessageCircle size={14} /> {recipe.comments}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className={styles["pagination"]}>
              <button className={`${styles["page-btn"]} ${styles["nav-btn"]}`}>
                <ChevronLeft size={16} />
              </button>
