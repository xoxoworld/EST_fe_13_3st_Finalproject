...
export default function MyPage() {
  ...
  const recipes = [
    ...
    },
    {
      ...
      likes: "890",
      image:
        "https://images.unsplash.com/photo-1605298135832-6bb5050f2da3?auto=format&fit=crop&w=400&q=80",
      isPublic: true,
    },
    {
      id: 8,
      ...
      likes: "0",
      image:
        "https://images.unsplash.com/photo-1626844131082-256783844137?auto=format&fit=crop&w=400&q=80",
      isPublic: false,
    },
  ];
        ...
        <div className={styles["profile-section"]}>
          ...
          <div className={styles["profile-stats"]}>
            <div className={styles["stat-item"]}>
              <span className={styles["stat-icon"]} style={{ color: "var(--brand-primary)" }}>
                🍴
              </span>
            ...
            <div key={recipe.id} className={styles["recipe-card"]}>
              ...
              <div className={styles["recipe-content"]}>
                ...
                <div className={`text-sm ${styles["recipe-meta"]}`}>
                  ...
                  <span>
                    <Heart size={14} /> {recipe.likes}
                  </span>
                </div>
                <div className={styles["recipe-actions"]}>
                  <button className={`text-button ${styles["btn-card-action"]}`}>
                    <Pencil size={14} /> 수정
                  </button>
